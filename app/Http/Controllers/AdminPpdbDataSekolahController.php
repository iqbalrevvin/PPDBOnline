<?php namespace App\Http\Controllers;
	...
	class AdminPpdbDataSekolahController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Jenjang','name'=>'jenjang','type'=>'select','validation'=>'required','width'=>'col-sm-10','dataenum'=>'SD;SMP;SMA;SMK'];
			...
			//$this->form[] = ['label'=>'No Telp','name'=>'no_telp','type'=>'number','validation'=>'required|numeric','width'=>'col-sm-9','help'=>'Masukan Url Facebook Sekolah (Contoh:https://facebook.com/smkikakartika)','placeholder'=>'Url Facebook Sekolah'];
			//$this->form[] = ['label'=>'Facebook','name'=>'facebook','type'=>'text','validation'=>'string','width'=>'col-sm-9','help'=>'Masukan Url Instagram Sekolah (Contoh:https://instagram.com/smkikakartika)','placeholder'=>'Url Instagram Sekolah'];
			//$this->form[] = ['label'=>'Instagram','name'=>'instagram','type'=>'text','validation'=>'string','width'=>'col-sm-9','help'=>'Masukan Url Twitter Sekolah (Contoh:https://twitter.com/smkikakartika)','placeholder'=>'Url Twitter Sekolah'];
			//$this->form[] = ['label'=>'Twitter','name'=>'twitter','type'=>'text','validation'=>'string','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'Latitude','name'=>'latitude','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Longitude','name'=>'longitude','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Maps','name'=>'maps','type'=>'googlemaps','width'=>'col-sm-5'];
