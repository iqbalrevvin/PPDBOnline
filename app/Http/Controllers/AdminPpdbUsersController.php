<?php namespace App\Http\Controllers;
	...
	class AdminPpdbUsersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Hak Akses","name"=>"id_cms_privileges","join"=>"cms_privileges,name"];
			...
			$this->form[] = ['label'=>'Foto','name'=>'photo','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10','help'=>'Tipe file yang didukung: JPG, JPEG, PNG, GIF, BMP'];
			...
			// $this->form[] = ['label'=>'Hak Akses','name'=>'id_cms_privileges','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_privileges,name'];
